            ...
            <div class="card-body">         
              <div class="table-responsive text-center">
                <table class="table table-hover">            
                  <tbody>
                    @foreach (company_all_notification('company', auth('company')->id()) as $notification )
                        <tr>
                            {{-- <a href="" class="dropdown-item">
                              ...
                              <div class="alert alert-success" role="alert">
                                {{$notification->title}} <small>({{$notification->created_at->diffForHumans()}})</small> <small class="text-danger">{{$notification->status}}</small> <a href="{{url($notification->link)}}">view</a>
                              </div>
                        </tr>
                    @endforeach
                  </tbody>
