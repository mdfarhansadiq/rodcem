        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0 text-uppercase">Add New Agent</h4>
                </div>
                <div>
        ...
        <div class="row">
            <div class="modal-body">
                <div class="col-md-10 mx-auto grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-uppercase">Add New Agent</h4>
                           <form method="POST" action="{{ route('super.agent.register') }}" class="pt-3">
                                @csrf
