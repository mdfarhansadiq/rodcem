                            ...
                            <div class="modal-body">
                                <div class="col-md-10 mx-auto grid-margin stretch-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>Image <span class="text-danger">* (Recommended Dimenssion 140 X 100 PX) <small>PNG</small></span></label>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        @foreach ($categories as $row )                            
                            <tr>
                                <td>
                                    <img src="{{asset('product/category/'.$row->image)}}" alt="">
                                </td>
                                <td>
                                    {{$row->name}}
                                </td>
                                <td>
                                    ...
                                    @push('all_models')
                                    <form class="forms-sample" action="{{route('category.update',$row->id)}}" method="post" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                                ...
                                                <div class="modal-body">
                                                    <div class="col-md-10 mx-auto grid-margin stretch-card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                <img width="100" src="{{asset('product/category/'.$row->image)}}" alt="">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Image <span class="text-danger">* (Recommended Dimenssion 140 X 100 PX) <small>PNG</small></span></label>
