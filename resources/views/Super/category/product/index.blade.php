        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0 text-uppercase">Product Category List</h4>
                </div>
                <div>
                ...
                @push('all_models')
                <form class="forms-sample" action="{{route('super.product.category.store')}}" method="post" enctype="multipart/form-data">
                 @csrf
                                ...
                                <div class="col-md-10 mx-auto grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <label>Category Image <span class="text-danger">(Recommended Image Dimenssion 140 X 97 PX)</span></label>
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Product Category List <span class="badge bg-primary"></span></p>
                      ...
                      <tbody>
                        @foreach ($categories as $row )
                            <tr>
                                ...
                                <td>
                                    <img src="{{asset('product/category/'.$row->image)}}" alt="product category image">
                                </td>
                                <td>
                                    {{$row->name}}
                                </td>
                                <td>
                                    ...
                                    @push('all_models')
                                    <form class="forms-sample" action="{{route('super.product.category.update',$row->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                                    ...
                                                    <div class="col-md-10 mx-auto grid-margin stretch-card">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                ...
                                                                <div class="form-group">
                                                                    <img width="150" src="{{asset('product/category/'.$row->image)}}" alt="product category">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Category Image<span class="text-danger">(Recommended Image Dimenssion 140 X 97 PX)</span></label>
                                    ...
                                    @push('all_models')
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{route('super.product.category.delete',$row->id)}}" class="btn btn-danger">Submit</a>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
