        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0 text-uppercase">Expert Category List</h4>
                </div>
                <div>
                ...
                @push('all_models')
                <form class="forms-sample" action="{{route('super.expert.category.store')}}" method="post" enctype="multipart/form-data">
                 @csrf
          ...
          <div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <p class="card-title mb-0">Expert Category List <span class="badge bg-primary"></span></p>
                        ...
                        @foreach ($categories as $row )
                            <tr>
                                ...
                                <td>
                                    ...
                                    @push('all_models')
                                    <form class="forms-sample" action="{{route('super.expert.category.update',$row->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    @push('all_models')
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{route('super.expert.category.delete',$row->id)}}" class="btn btn-danger">Submit</a>
                                            </div>
                                            </div>
                                        </div>
                                        </div>
