          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0 text-uppercase">Benefit List</h4>
                </div>
                <div>
                ...
                @push('all_models')
                <form class="forms-sample" action="{{route('benifit.index')}}" method="post" enctype="multipart/form-data">
                 @csrf
                                ...
                                <div class="col-md-10 mx-auto grid-margin stretch-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="exampleTextarea1" name="description" required rows="4"></textarea>
                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        @foreach ($benefits as $row )                            
                            <tr>
                                <td>
                                    <img src="{{asset('super/benefit/'.$row->image)}}" alt="">
                                </td>
                                <td>
                                    {{$row->title}}
                                </td>
                                ...
                                <td>
                                    ...
                                    @push('all_models')
                                    <form class="forms-sample" action="{{route('benifit.update',$row->id)}}" method="post" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                                ...
                                                <div class="modal-body">
                                                    <div class="col-md-10 mx-auto grid-margin stretch-card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleTextarea1">Description <span class="text-danger">*</span></label>
                                                                <textarea class="form-control" id="exampleTextarea1" name="description" required rows="4">{{$row->description}}</textarea>
                                                                @error('description')<div class="text-danger">{{$message}}</div> @enderror
                                                            </div>
                                                            <div class="form-group">
                                                                <img width="100" src="{{asset('super/benefit/'.$row->image)}}" alt="">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Image <span class="text-danger">*</span></label>
                                    ...
                                    @push('all_models')
                                    <form action="{{route('benifit.destroy',$row->id)}}" method="post">
                                        @method('delete')
                                        @csrf
