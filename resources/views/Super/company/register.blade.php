        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0 text-uppercase">Add New Comapny</h4>
                </div>
                <div>
        ...
        <div class="row">
            <div class="modal-body">
                <div class="col-md-10 mx-auto grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title text-uppercase">Add New Comapny</h4>
                           <form method="POST" action="{{ route('super.company.register') }}" class="pt-3">
                                @csrf
                                ...
                                <select name="category" class="form-control" style="color:#2E3192" id="exampleFormControlSelect2">
