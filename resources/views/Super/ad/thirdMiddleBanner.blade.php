        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="font-weight-bold mb-0 text-uppercase">Middle Third Ad</h4>
                    </div>
                </div>
            </div>
        </div>
          <div class="row">
            <div class="col-md-10 mx-auto grid-margin stretch-card">
                <div class="card">
                 <div class="card-body">
                    <h4 class="card-title text-uppercase">Third Middle AD</h4>
                    <form action="{{route('super.ad.third.middle.banner.update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    @if($item && $item->image)
                        <div class="form-group">
                            <img width="120" src="{{asset('ad/third/middle/banner/'.$item->image)}}" alt="about_us">
                        </div>
                    @endif
                    <div class="form-group">
                        <label>Ad Image <span class="text-danger">(Recommended Size 790 x 200 PX)</span></label>
