        ...
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="font-weight-bold mb-0 text-uppercase">Second Left Banner Ad</h4>
                    </div>
                </div>
            </div>
        </div>
          <div class="row">
            <div class="col-md-10 mx-auto grid-margin stretch-card">
                <div class="card">
                 <div class="card-body">
                    <h4 class="card-title text-uppercase">Second Left Banner AD</h4>
                    <form action="{{route('super.ad.second.left.banner.update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="title" class="form-control"  value="{{$item->title_four ?? ''}}"  name="title_four">
                    </div>
                    ...
                    @if($item && $item->image)
                        <div class="form-group">
                            <img width="120" src="{{asset('ad/second/left/banner/'.$item->image)}}" alt="second_left_banner">
                        </div>
                    @endif
                    <div class="form-group">
                        <label>Image <span class="text-danger">(Recommended Size 375 x 980 PX)</span></label>
