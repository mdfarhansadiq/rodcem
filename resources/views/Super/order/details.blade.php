                        ...
                        @foreach ($order->order_details as $details )
                          ...
                          <tr>
                            ...
                            @if ($order->status == 'pending')                                 
                              <a href="{{route('super.order.approved',$order->id)}}" class="btn  btn-success">Approve</a>                    
                            @endif                            
                            @if ($order->status == 'cancel_by_admin')                                
                              <a class="btn btn-danger" data-toggle="modal" data-target="#order_cancel">Cancel By Rodcem</a>  
                            @else 
                              @if($order->status == 'pending')                                
                                ...
                                <div class="modal fade" id="order_cancel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        ...
                                        <form action="{{route('super.order.cancel',$order->id)}}" method="post">
