...
<body class="bg-effect">
    ...
    <section class="user-dashboard-section section-b-space">
        <div class="container-fluid-lg">
            <div class="row">
                @if (auth('expert')->user()->status == 0)
                    <div class="alert alert-danger" role="alert">
                        Your account is now <strong>Pending..</strong> Need <strong>Admin Approval!</strong></div>
                @endif
                @if (auth('expert')->user()->status == 10)
                    <div class="alert alert-danger" role="alert"> Your account is now <strong>Deactive..!</strong> </strong> {{auth('expert')->user()->message}}</div>
                @endif
                    ...
                    <div class="dashboard-left-sidebar">
                            ...
                            <div class="profile-contain">
                                <div class="profile-image">
                                    <div class="position-relative">
                                        @if (auth('expert')->user()->image)
                                            <img src="{{asset('expert/profile/'.auth('expert')->user()->image)}}" class="blur-up lazyload update_img" alt="">
                                        @else
                                ...
                                <div class="profile-name">
                                    <h3>{{auth('expert')->user()->name}}</h3>
                                    <h6 class="text-content">{{auth('expert')->user()->email}}</h6>
                                </div>
                            </div>
                        </div>
                        ...
                        <ul class="nav nav-pills user-nav-pills" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="{{route('expert.dashboard')}}" class="nav-link @yield('expert_dashboard')"><i data-feather="home"></i>  DashBoard</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a href="{{route('expert.projects.index')}}" class="nav-link @yield('projects')"><i data-feather="user"></i> Project</a>
                            </li>
                            {{-- <li class="nav-item" role="presentation">
                                <a href="{{route('expert.orders')}}" class="nav-link @yield('orders')"><i data-feather="shopping-bag"></i>Order</a>
                            </li> --}}
                            {{-- <li class="nav-item" role="presentation">
                                <a href="{{route('expert.location')}}" class="nav-link @yield('location')"><i data-feather="map-pin"></i>Location</a>
                            </li> --}}
                            <li class="nav-item" role="presentation">
                                <a href="{{route('expert.profile')}}" class="nav-link @yield('profile')"><i data-feather="user"></i> Profile</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a href="{{route('expert.password.change')}}" class="nav-link @yield('password_change')"><i data-feather="eye"></i> Password Change</a>
                            </li>
                            <li class="nav-item" role="presentation">
