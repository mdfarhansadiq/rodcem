            ...
            <tbody>
                @foreach ($orders as $item )
                    <tr>
                        ...
                        <td>
                            <a href="{{route('company.shop',$item->company->slug)}}">{{ $item->company->name}}</a>
                        </td>
                        <td>
                            @if(agent_total_price($item->id))
                        ...
                        <td>
                            ...
                            @elseif ($item->status == 'product_receive')
                                <label class="text-capitalize success">Complete</label>
                            @endif
                        </td>
                        <td>
                            <a href="{{route('user.order.details',$item->id)}}"><span class="text-success"><i class="fa fa-eye"></i></span></a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
