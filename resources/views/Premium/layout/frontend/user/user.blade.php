                    ...
                    <div class="dashboard-left-sidebar">
                            ...
                            <div class="profile-contain">
                                <div class="profile-image">
                                    <div class="position-relative">
                                        @if (auth()->user()->image)
                                            <img src="{{asset('user/profile/'.auth()->user()->image)}}" class="blur-up lazyload update_img" alt="">
                                        @else
                        ...
                        <ul class="nav nav-pills user-nav-pills" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a href="{{route('user.dashboard')}}" class="nav-link @yield('user_dashboard')"><i data-feather="home"></i>  DashBoard</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a href="{{route('user.orders')}}" class="nav-link @yield('orders')"><i data-feather="shopping-bag"></i>Order</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a href="{{route('user.location')}}" class="nav-link @yield('location')"><i data-feather="map-pin"></i>Location</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a href="{{route('user.profile')}}" class="nav-link @yield('profile')"><i data-feather="user"></i> Profile</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a href="{{route('user.password.change')}}" class="nav-link @yield('password_change')"><i data-feather="eye"></i> Password Change</a>
                            </li>
                            <li class="nav-item" role="presentation">
