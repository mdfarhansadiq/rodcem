                        ...
                        <div class="order-box">
                            {{-- <div class="order-image">
                                <div class="checkmark">
                                    ...
                                    <svg class="checkmark__check" height="36" viewBox="0 0 48 36" width="48" xmlns="{{asset('about/us/default.jpg')}}">
                            ...
                            <div class="order-contain">
                                <h3 class="text-danger">Payment Fail</h3>
                                <h5 class="text-content">Payment Is Not  Successfully Please Try Again</h5>
