                ...
                <div class="as-invoice invoice_style1">
                    <div class="download-inner" id="download_section">
                        <header class="as-header header-layout1">
                            ...
                            <div class="header-bottom">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <p class="invoice-number me-4"><b>Transaction id: </b>#{{$trangection_id}}</p>
                                    </div>
                                    <div class="col-auto">
                        ...
                        <div class="row justify-content-between mb-4">
                            ...
                            <div class="col-auto">
                                <div class="invoice-right"><b>Paid By:</b>
                                    <address>
                                        {{auth('agent')->user()->name}}<br>
                                        {{auth('agent')->user()->email}}<br>
                                        {{auth('agent')->user()->phone_number}}<br>
                        ...
                        <table class="invoice-table">
                            ...
                            <tbody>
                                    <tr>
                                        ...
                                        <td>{{one_time_paymet()->subscription_duration}} Month</td>
                                        <td>{{one_time_paymet()->amount}} <sup>Tk</sup></td>
                                    </tr>
                                <tr>
                                    <td colspan="5">&nbsp;</td>
                                </tr>
                    ...
                    <div class="invoice-buttons">
                        <button class="print_btn"><svg width="16" height="16"
                                ...
                                <path
                                    ...
                                    fill="white" />
                            </svg> <span>Print</span></button> <button id="download_btns" class="download_btn"><svg
