...
@section('title')
    {{ config('app.name') }} | Become A Company
@endsection
@section('custom_css')
    <style>
     li {
                    ...
                    <div class="breadscrumb-contain">
                        ...
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Become a Company</li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="seller-title h-100 d-flex align-items-center">
                        <div>
                            <h2>Become a Company on Rodcem...</h2>
                            <p>{!! joinWithUs()->become_company ?? '' !!}</p>
                        </div>
                    </div>
                </div>
            </div>
