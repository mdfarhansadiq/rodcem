...
<head>
    ...
    <link rel="apple-touch-icon" sizes="114x114"
        href="{{ asset('invoice/assets') }}/img/favicons/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120"
        href="{{ asset('invoice/assets') }}/img/favicons/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144"
        href="{{ asset('invoice/assets') }}/img/favicons/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152"
        href="{{ asset('invoice/assets') }}/img/favicons/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('invoice/assets') }}/img/favicons/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"
        href="{{ asset('invoice/assets') }}/img/favicons/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('invoice/assets') }}/img/favicons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96"
        href="{{ asset('invoice/assets') }}/img/favicons/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('invoice/assets') }}/img/favicons/favicon-16x16.png">
                    ...
                    <div class="download-inner" id="download_section">
                        <header class="as-header header-layout1">
                            <div class="row align-items-center justify-content-between">
                                <div class="col-auto">
                                    <div class="header-logo"><a href="{{ route('front') }}"><img width="80"
                                                src="{{ asset('assets/rodcem/logo.png') }}" class="me-2"
                                                alt="logo" /></a></div>
                                </div>
                                <div class="col-auto">
                            ...
                            <div class="header-bottom">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <div class="border-line"><img
                                                src="{{ asset('invoice/assets') }}/img/bg/line_pattern.svg"
                                                alt="line">
                                        </div>
                                    </div>
                                    <div class="col-auto">
