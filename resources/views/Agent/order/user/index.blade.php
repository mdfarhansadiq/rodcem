          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0 text-uppercase">User All Order List</h4>
                </div>
                <div>
                    <a href="{{route('agent.user.orders')}}" class="btn btn-primary btn-icon-text btn-rounded">
            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-header">
                  ...
                  <form action="{{route('agent.user.order.search')}}" method="get">
                      <div class="input-group">
                        ...
                        <div class="input-group-append">
                          @if (request()->routeIs('agent.user.order.search'))
                            <button type="submit" class="btn btn-primary" type="button">Search</button>
                            <a href="{{route('agent.user.orders')}}" type="submit" class="btn btn-danger" type="button">Clear</a>
                          @else
                            <button type="submit" class="btn btn-primary" type="button">Search</button>
                          @endif
                        </div>
                  ...
                  <form action="{{route('agent.user.order.date.filter')}}" method="get">
                  <div class="row">
                      <div class="col-md-5">
                      ...
                      <div class="col-md-2">
                        <div class="form-group">
                          @if (request()->routeIs('agent.user.order.date.filter'))
                          <div class="d-flex justify-content-between">
                            <button class="btn btn-primary form-control mr-2" style="margin-top:30px">Filter</button>
                            <a href="{{route('agent.user.orders')}}" type="submit" class="btn btn-danger" type="button" style="margin-top:30px">Clear</a>
                          </div>
                          @else
                        ...
                        <tr>
                            ...
                            <td>
                              @if ($item->status == 'generated')
                                <span class="badge badge-pill bg-info text-capitalize">generated</span>
                              ...
                              @elseif ($item->status == 'user_confirm')
                                <span class="badge badge-pill bg-success text-capitalize">Confirm By Client</span>
                              ...
                              @elseif ($item->status == 'deliver')
                                <span class="badge badge-pill bg-success text-capitalize p-1">Delivered</span>
                            ...
                            <td>
                                <a href="{{route('agent.user.order.details',$item->id)}}"><span class="badge badge-pill bg-primary">Order Details</span></a>
