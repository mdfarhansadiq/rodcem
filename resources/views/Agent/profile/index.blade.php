        ...
        <div class="row">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <div class="card" style="width: 8rem;">
                            @if (Auth()->guard('agent')->user()->image)
                                <img class="card-img-top" src="{{asset('agent/profile/'.Auth()->guard('agent')->user()->image)}}" alt="Card image cap">
                            @else
                    ...
                    <form class="forms-sample" action="{{route('agent.profile.update')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" name="name" value="{{Auth()->guard('agent')->user()->name}}">
                            @error('name')<div class="text-danger">{{$message}}</div> @enderror
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Phone</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" name="phone_number" value="{{Auth()->guard('agent')->user()->phone_number}}">
                            @error('phone_number')<div class="text-danger">{{$message}}</div> @enderror
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Email address</label>
                            <input type="email" class="form-control" id="exampleInputEmail1" name="email" value="{{Auth()->guard('agent')->user()->email}}">
            ...
            <div class="col-md-4 mx-auto grid-margin">
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('agent.location.update')}}" method="post">
                        @csrf
                        @if($location)
                           <div class="form-group">
            ...
            <div class="col-md-12 mx-auto grid-margin stretch-card">
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{route('agent.password.update')}}" method="post">
                    @csrf
                        <div class="form-group">
