          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                ...
                @push('all_models')
                <form class="forms-sample" action="{{route('agent.portfolio.chooes.store')}}" method="post" enctype="multipart/form-data">
                 @csrf
                        ...
                        @foreach ($chooes as $row )                            
                            <tr>
                                ...
                                <td>
                                    ...
                                    @push('all_models')
                                    <form class="forms-sample" action="{{route('agent.portfolio.chooes.update',$row->id)}}" method="post" enctype="multipart/form-data">
                                    @method('put')
                                    @csrf
                                                ...
                                                <div class="modal-body">
                                                    <div class="col-md-10 mx-auto grid-margin stretch-card">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            {{-- <div class="form-group">
                                                                <img width="100" src="{{asset('agent/portfolio/choose/'.$row->image)}}" alt="">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Image <span class="text-danger">*</span></label>
                                    ...
                                    @push('all_models')
                                    <form action="{{route('agent.portfolio.chooes.destroy',$row->id)}}" method="post">
                                        @method('delete')
                                        @csrf
