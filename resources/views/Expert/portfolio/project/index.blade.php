      ...
      <div class="row">
        <div class="col-md-12 grid-margin">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <h4 class="font-weight-bold mb-0 text-uppercase">All Projects</h4>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    ...
                    @push('all_models')        
                    <form class="forms-sample" action="{{route('expert.portfolio.project.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                    <label>Service Image <span class="text-danger">(Recommended Image Size 370 X 370 PX)</span></label>
                ...
                <table class="table text-center">
                    ...
                    @foreach ($projects as $row)
                        <tr>     
                            <td>
                              <img src="{{asset('expert/portfolio/project/'.$row->image)}}" alt="">
                            </td>        
                            <td>{{$row->title}}</td>
                            ...
                            <td>
                                ...
                                @push('all_models')        
                                <form class="forms-sample" action="{{route('expert.portfolio.project.update', $row->slug)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                      ...
                                      <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              ...
                                              <div class="form-group">
                                                <label for="exampleFormControlSelect3">Category select</label>
                                                <select name="category_id" class="form-control form-control-sm" id="exampleFormControlSelect3">
                                                  @foreach ($categories as $category)                                                    
                                              ...
                                              <div class="form-group">
                                                <img width="100" src="{{asset('expert/portfolio/project/'.$row->image)}}" alt="">
                                              </div>
                                              <div class="form-group">
                                                <label>Service Image <span class="text-danger">(Recommended Image Size 370 X 370 PX)</span></label>
                                  ...
                                  <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <a href="{{route('expert.portfolio.project.delete', $row->slug)}}" class="btn btn-danger">Submit</a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
