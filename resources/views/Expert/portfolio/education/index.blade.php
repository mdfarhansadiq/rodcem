      ...
      <div class="row">
        <div class="col-md-12 grid-margin">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <h4 class="font-weight-bold mb-0 text-">Educational Qualification</h4>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <h4 class="card-title">Education Qualification List</h4>
                    <a  class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">+ Add New</a>
                    @push('all_models')        
                    <form class="forms-sample" action="{{route('expert.portfolio.education.store')}}" method="post">
                        @csrf
                        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitle">Add New Qualification</h5>
                    ...
                    @foreach ($qualifications as $row)
                        <tr>
                            ...
                            <td>
                                ...
                                @push('all_models')        
                                <form class="forms-sample" action="{{route('expert.portfolio.education.update', $row->slug)}}" method="post">
                                    @csrf
                                  ...
                                  <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <a href="{{route('expert.portfolio.education.delete', $row->slug)}}" class="btn btn-danger">Submit</a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
