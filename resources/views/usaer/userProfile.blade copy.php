                            ...
                            <table class="table">
                                ...
                                <tbody>                         
                                    <tr>
                                        <td>                  
                                            @if($user->agent->image)
                                                <img width="50" src="{{asset('agent/profile/'.$user->agent->image)}}" alt="">
                                            @else
                                                <img width="50" src="{{asset('assets/rodcem/agents (2).jpg')}}" alt="">
                                            @endif
                                        </td>
                                        <td>
                                            {{$user->agent->name}} <span class="">({{$user->agent->location->upazila->name}} , {{$user->agent->location->union->name}} )</span>
                                        </td>
                                        <td>
                                            <a href="{{route('agent.details',$user->agent->slug)}}" class="badge bg-success">View</a>
                                        </td>
                                    </tr>                     
                                </tbody>
                            </table>
