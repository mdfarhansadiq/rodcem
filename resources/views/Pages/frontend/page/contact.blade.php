                            ...
                            <div class="row">
                                <div class="col col-lg-10 offset-lg-1">
                                            ...
                                            <div class="col col-xl-4 col-lg-6 col-md-6 col-12">
                                                <div class="office-info-item">
                                                    ...
                                                    <div class="office-info-text">
                                                        ...
                                                        <p>{{general_setting()->email_secoend ?? ''}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col col-xl-4 col-lg-6 col-md-6 col-12">
                                                <div class="office-info-item">
                                                    ...
                                                    <div class="office-info-text">
                                                        ...
                                                        <p>{{general_setting()->phone_secoend ?? ''}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="wpo-contact-form-area">
                                        <form  action="{{route('contact.store')}}" method="post" class="" id="">
                                            @csrf
                                            <div>
                                            ...
                                            <div>
                                                <input type="text" class="form-control" name="phone_number" id="adress"
