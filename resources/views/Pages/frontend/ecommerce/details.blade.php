                        ...
                        <div class="col-lg-5">
                            <div class="product-single-img">
                                <div class="product-active owl-carousel">
                                    <div class="item">
                                        <img src="{{asset('theme/assets')}}/images/product-details/1.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="{{asset('theme/assets')}}/images/product-details/2.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="{{asset('theme/assets')}}/images/product-details/3.jpg" alt="">
                                    </div>
                                    <div class="item">
                                        <img src="{{asset('theme/assets')}}/images/product-details/1.jpg" alt="">
                                    </div>
                                                            ...
                                                            <div id="div-comment-1">
                                                                <div class="comment-theme">
                                                                    <div class="comment-image"><img
                                                                            src="{{asset('theme/assets')}}/images/blog-details/comments-author/img-1.jpg"
                                                                            alt></div>
                                                                </div>
                                                            ...
                                                            <ul class="children">
                                                                <li class="comment">
                                                                    <div>
                                                                        <div class="comment-theme">
                                                                            <div class="comment-image"><img
                                                                                    src="{{asset('theme/assets')}}/images/blog-details/comments-author/img-2.jpg"
                                                                                    alt></div>
                                                                        </div>
                                                                        <div class="comment-main-area">
                                                                            <div class="comment-wrapper">
